...
CREATE TABLE IF NOT EXISTS filming_pelify_movies (
...
CREATE TABLE IF NOT EXISTS filming_pelify_filming_locations (
    id                  BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    created_at          TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at          TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_filming_locations_movie FOREIGN KEY (movie_id) REFERENCES filming_pelify_movies(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS filming_pelify_nearby_places (
    id              BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS filming_pelify_location_nearby_cache (
    id                      BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    ...
    created_at              TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at              TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_location_nearby_cache_location FOREIGN KEY (filming_location_id) REFERENCES filming_pelify_filming_locations(id) ON DELETE CASCADE,
    CONSTRAINT fk_location_nearby_cache_place FOREIGN KEY (nearby_place_id) REFERENCES filming_pelify_nearby_places(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS filming_pelify_api_jobs (
    id                      BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    filming_location_id     BIGINT UNSIGNED NOT NULL,
    ...
    created_at              TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
    updated_at              TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT fk_api_jobs_location FOREIGN KEY (filming_location_id) REFERENCES filming_pelify_filming_locations(id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS filming_pelify_analytics_events (
    id                      BIGINT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
